...
const appRoutes: Routes = [
    ...
    { path: 'factura-compra', component: FacturaCompraComponent, canActivate: [UsuarioGuard] },
    { path: 'factura-venta', component: FacturaVentaComponent, canActivate: [UsuarioGuard] },
