...
const appRoutes: Routes = [
    ...
    { path: 'editar-usuario', component: EditarUsuarioComponent, canActivate: [UsuarioGuard] },
    { path: 'editar-empleado', component: EditarEmpleadoComponent, canActivate: [UsuarioGuard] },
    { path: 'editar-proveedor', component: EditarProveedorComponent, canActivate: [UsuarioGuard] },
    { path: 'editar-cliente', component: EditarClienteComponent, canActivate: [UsuarioGuard] },
